...
class ClienteLocal:
    ...
    # --- AGREGADO TP07 EXTENSION (autorizado por el docente): generico
    # por nombre en vez de un metodo fijo para "siu", asi cada jugador
    # nuevo es una entrada de datos en robots.py + acciones.py, no un
    # metodo nuevo aca. El servidor (_orden_gesto) sigue siendo el que
