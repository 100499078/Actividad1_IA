...
class SimuladorOficial:
    ...
    def _escribir_pose(self):
        ...
        # --- FIX (ver TP07): esto comparaba contra ("saludando", "besando"),
        # pero el nombre que llega en `accion` es el de la orden de gesto --
        # "saludo", "dar_la_mano", "siu", "messi"... -- asi que la condicion
        # NUNCA se cumplia y ningun gesto se animaba, ni siquiera el saludo.
        # `visor.py` tenia este mismo fix hecho, pero en una clase `Visor` que
        # no usa nadie: `_escribir_pose`, aca, es la que corre de verdad.
